...
async def index_files(bot, query):
    ...
    if raju == 'reject':
        ...
        await bot.send_message(int(from_user),
                               f'Your Submission for indexing {chat} has been declined by our Admins.',
...
async def send_for_index(bot, message):
    ...
    try:
        ...
        return await message.reply('Make Sure That Iam An Admin In The Channel, if the channel is private')
    if k.empty:
    ...
    await bot.send_message(LOG_CHANNEL,
                           ...
                           reply_markup=reply_markup)
    await message.reply('Thank you For the Contribution 🖤, Wait For My Admins to verify the files ✅')
